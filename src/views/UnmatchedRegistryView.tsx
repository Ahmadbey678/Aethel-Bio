  ...
  return (
    ...
    >
      <button
        ...
        className="flex w-full cursor-pointer items-center justify-between gap-3 px-4 py-3 text-left transition-colors duration-150 hover:bg-surface-hover/50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-primary"
      >
      ...
      {open && (
        <div id="sponsor-analytics-body" className="border-t border-border-subtle/70 px-4 pb-4 pt-4">
